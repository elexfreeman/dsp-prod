                    ...
                    <form class="form-horizontal" name="s_form" role="form">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <label
                                        ng-class="{'active':formInfo.rhb_res == '1'}"
                                        class="form-radio form-normal form-text form-danger">
                                        <input type="radio"
                                               ng-checked="(formInfo.rhb_res == '1')"

                                               ng-model="formInfo.rhb_res" name="resid" value="1"> Выполненно
                                    </label>
                                    <label
                                        ng-class="{'active':formInfo.rhb_res == '0'}"
                                        class="form-radio form-normal  form-text form-danger">
                                        <input type="radio"
                                               ng-checked="(formInfo.rhb_res == '0')"
                                               ng-model="formInfo.rhb_res" name="resid" value="0"> Не выполненно
                                    </label>
